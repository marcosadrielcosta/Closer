...
public class NovaLeitura extends AppCompatActivity {
    ...
    String data, titulo, versiculo, corpo;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.addNota:
                ...
                db.addNota(new Nota(etTitulo.getText().toString(), versiculo,
